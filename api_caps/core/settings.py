...
SECRET_KEY = 'django-insecure-j*cjca)w7wha-i83*&t3iv174pk1#l=3xg6##7p$)29%(tcp2@'
...
ALLOWED_HOSTS = [
    "127.0.0.1",
    "localhost",
    "trivia-jobs-yamaha-antibodies.trycloudflare.com",
]

CSRF_TRUSTED_ORIGINS = [
    "https://trivia-jobs-yamaha-antibodies.trycloudflare.com",
]
